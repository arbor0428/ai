	...
	<div class="container">
		<div style="display: flex; align-items: center; justify-content: space-between; margin:0 20px 40px;">
			...
			<div class="sub_btn_wrap">
				<a id="ratio811" href="" title="">80:10:10</a>
				<a id="ratio82" href="" title="">80:20</a>
				<a id="ratio721" href="" title="">70:20:10</a>
				<a id="ratio73" href="" title="">70:30</a>
			</div>
		</div>
				...
				<div class="result_show_img_wrap">
					<div class="result_row_list">
						<div class="result_row">
							<div class="result_row_tit">Training Data</div>
						...
						<div class="result_row">
							<div class="result_row_tit">Validation Data</div>
							<div class="result_row_det">
								<input id="validation" type="text">
								건
							</div>
						</div>
						<div class="result_row">
							<div class="result_row_tit">Testing Data</div>
							<div class="result_row_det">
...
<script>
	//ratio 결과값 보이게 
	$("#ratio811").click(function(event) {
		event.preventDefault();

		$("#training").val('8,000');
		$("#validation").val('1,000');
		$("#testing").val('1,000');
